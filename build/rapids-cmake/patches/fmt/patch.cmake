...
function(rapids_cpm_run_git_patch file issue)
  ...
  if(result EQUAL 0)
    ...
    list(APPEND msg_state "rapids-cmake [fmt]: failed to apply ${ext} ${file_name}")
    list(APPEND msg_state "rapids-cmake [fmt]: git ${ext} output: ${repo_error_info}")
  endif()
...
set(files "/home/intern-04/binius-gpu/build/_deps/rapids-cmake-src/rapids-cmake/cpm/patches/fmt/no_debug_warnings.diff")
set(issues "No warnings during debug builds [https://github.com/fmtlib/fmt/issues/3351]")
set(output_file "/home/intern-04/binius-gpu/build/rapids-cmake/patches/fmt/log")
